...
//string arduino::getModel() const { return "Arduino"; };
...
bool arduino::ApriSer(string mynome, bool verbose){
	...
	if(verbose) cout << endl << "---------[" << getNome() << "]" << MSG_APRI_SER << nome << " : ";
...
void arduino::InizializzaPortaSeriale(){
...
void arduino::InviaMessaggioOW(string indirizzo, int canale, bool celsius, bool verbose, bool ris) {
	string comando = "";
	// Imposta il comando
	comando += 'r';
...
string arduino::CreaRigaImpostazioni() {
